...
Blockly.Msg.FR_MOTORS_PIVOT_DELAY_TIP = "Pivot motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_DIRECTION = "direction:";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_SPEED = "speed(%):";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_TIP = "Pivot motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";  // untranslated
