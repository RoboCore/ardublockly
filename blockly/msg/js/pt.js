...
Blockly.Msg.ARD_ANALOGREAD = "ler pino analógico#";
Blockly.Msg.ARD_ANALOGREAD_TIP = "Retorna valor entre 0 e 1024";
Blockly.Msg.ARD_ANALOGWRITE = "setar pino analógico#";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Escreve valor analógico entre 0 e 255 em um pino PWM.";
Blockly.Msg.ARD_BUILTIN_LED = "setar LED da placa";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Liga ou desliga o LED embarcado do Arduino";
Blockly.Msg.ARD_COMPONENT_WARN1 = "Um bloco de configuração de %1 com o mesmo nome %2 precisa ser adicionado para usar esse bloco!";
Blockly.Msg.ARD_DEFINE = "Define";
Blockly.Msg.ARD_DIGITALREAD = "ler pino digital#";
Blockly.Msg.ARD_DIGITALREAD_TIP = "Lê o valor de um pino digital: ALTO ou BAIXO.";
Blockly.Msg.ARD_DIGITALWRITE = "setar pino digital#";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Escreve valor digital ALTO ou BAIXO em um pino.";
Blockly.Msg.ARD_FUN_RUN_LOOP = "Arduino repetir para sempre:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "Arduino executar primeiro:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Define as funções setup() e loop() do Arduino.";
Blockly.Msg.ARD_HIGH = "ALTO";
Blockly.Msg.ARD_HIGHLOW_TIP = "Define o estado lógico de um pino como ALTO ou BAIXO.";
Blockly.Msg.ARD_LOW = "BAIXO";
Blockly.Msg.ARD_MAP = "Mapear";
Blockly.Msg.ARD_MAP_TIP = "Remapear um número de [0-1024] para outro.";
Blockly.Msg.ARD_MAP_VAL = "valor para [0-";
Blockly.Msg.ARD_NOTONE = "Desligar gerador de tons no pino#";
Blockly.Msg.ARD_NOTONE_PIN = "Parar o tom no pino#";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Para de gerar tons em um pino.";
Blockly.Msg.ARD_NOTONE_TIP = "Desliga a geração de tons no pino selecionado.";
Blockly.Msg.ARD_PIN_WARN1 = "Pino %1 é necessário para %2 como pino %3. Já utilizado como %4.";
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Medir a duração do pulso no pino selecionado, se estiver dentro do tempo limite em microssegundos.";
Blockly.Msg.ARD_PULSE_READ = "medir %1 pulso no pino #%2";
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "medir %1 pulso no pino #%2 (timeout após %3 μs)";
Blockly.Msg.ARD_PULSE_TIP = "Medir a duração do pulso no pino selecionado.";
Blockly.Msg.ARD_SERIAL_BPS = "bps";
Blockly.Msg.ARD_SERIAL_PRINT = "imprimir";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "adiciona nova linha";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "Imprime dados para a porta serial em texto ASCII legível.";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "Um bloco de configuração para %1 precisa ser adicionado para a área de trabalho para usar esse bloco!";
Blockly.Msg.ARD_SERIAL_SETUP = "Configurar";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Seleciona a velocidade para comunicação Serial.";
Blockly.Msg.ARD_SERIAL_SPEED = ":  velocidade para";
Blockly.Msg.ARD_SERVO_READ = "ler ângulo do SERVO no pino#";
Blockly.Msg.ARD_SERVO_READ_TIP = "Lê o ângulo do servo em um pino.";
Blockly.Msg.ARD_SERVO_WRITE = "setar ângulo do SERVO no pino";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "graus (0~180)";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Define o ângulo do servo conectado a um pino.";
Blockly.Msg.ARD_SERVO_WRITE_TO = "para";
Blockly.Msg.ARD_SETTONE = "Setar tom no pino#";
Blockly.Msg.ARD_SPI_SETUP = "Configurar";
Blockly.Msg.ARD_SPI_SETUP_CONF = "parâmetros:";
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "divisor do relógio";
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSB Primeiro";
Blockly.Msg.ARD_SPI_SETUP_MODE = "Modo SPI (inativo - borda)";
Blockly.Msg.ARD_SPI_SETUP_MODE0 = "0 (Baixo - Caindo)";
Blockly.Msg.ARD_SPI_SETUP_MODE1 = "1 (Baixo - Subindo)";
Blockly.Msg.ARD_SPI_SETUP_MODE2 = "2 (Alto - Caindo)";
Blockly.Msg.ARD_SPI_SETUP_MODE3 = "3 (Alto - Subindo)";
Blockly.Msg.ARD_SPI_SETUP_MSBFIRST = "MSB Primeiro";
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "deslocamento dos dados";
Blockly.Msg.ARD_SPI_SETUP_TIP = "Configura a comunicação SPI.";
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "Envia uma mensagem via SPI para um dispositivo escravo especificado e obtém mensagem de retorno.";
Blockly.Msg.ARD_SPI_TRANS_NONE = "nenhum";
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "para escravo no pino";
Blockly.Msg.ARD_SPI_TRANS_TIP = "Envia uma mensagem via SPI para um dispositivo escravo especificado.";
Blockly.Msg.ARD_SPI_TRANS_VAL = "transferir";
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "Um bloco de configuração para %1 precisa ser adicionado para a área de trabalho para usar esse bloco!";
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "O valor antigo do pino %1 não está mais disponível.";
Blockly.Msg.ARD_STEPPER_COMPONENT = "motor de passo";
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "MeuMotorDePasso";
Blockly.Msg.ARD_STEPPER_FOUR_PINS = "4";
Blockly.Msg.ARD_STEPPER_MOTOR = "motor de passo:";
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "Número de pinos";
Blockly.Msg.ARD_STEPPER_PIN1 = "pino1#";
Blockly.Msg.ARD_STEPPER_PIN2 = "pino2#";
Blockly.Msg.ARD_STEPPER_PIN3 = "pino3#";
Blockly.Msg.ARD_STEPPER_PIN4 = "pino4#";
Blockly.Msg.ARD_STEPPER_REVOLVS = "número de passos por revolução";
Blockly.Msg.ARD_STEPPER_SETUP = "Configura motor de passo";
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Configura os pinos e outros parâmetros de um motor de passo.";
Blockly.Msg.ARD_STEPPER_SPEED = "definir velocidade(rpm) para";
Blockly.Msg.ARD_STEPPER_STEP = "mover motor de passo";
Blockly.Msg.ARD_STEPPER_STEPS = "passos";
Blockly.Msg.ARD_STEPPER_STEP_TIP = "Move o motor em um número espefífico de passos.";
Blockly.Msg.ARD_STEPPER_TWO_PINS = "2";
Blockly.Msg.ARD_TIME_DELAY = "aguardar";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "microssegundos";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Aguarda um tempo específico em microssegundos.";
Blockly.Msg.ARD_TIME_DELAY_TIP = "Aguarda um tempo específico em milissegundos.";
Blockly.Msg.ARD_TIME_INF = "esperar para sempre (fim do programa)";
Blockly.Msg.ARD_TIME_INF_TIP = "Espera indefinidamente, parando o programa.";
Blockly.Msg.ARD_TIME_MICROS = "tempo decorrido até o momento (microssegundos)";
Blockly.Msg.ARD_TIME_MICROS_TIP = "Retorna o tempo decorrido em microssegundos desde que o Arduino começou a executar o programa atual. Deve ser armazenado em uma variável longa inteira positiva.";
Blockly.Msg.ARD_TIME_MILLIS = "tempo decorrido até o momento (milissegundos)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Retorna o tempo decorrido em milissegundos desde que o Arduino começou a executar o programa atual. Deve ser armazenado em uma variável longa inteira positiva.";
Blockly.Msg.ARD_TIME_MS = "milissegundos";
Blockly.Msg.ARD_TONEFREQ = "na frequência";
Blockly.Msg.ARD_TONE_FREQ = "frequência";
Blockly.Msg.ARD_TONE_PIN = "Tonificar o pino#";
Blockly.Msg.ARD_TONE_PIN_TIP = "Gera tons sonoros em um pino.";
Blockly.Msg.ARD_TONE_TIP = "Seta tom em um pino com a frequência entre 31 e 65535";
Blockly.Msg.ARD_TONE_WARNING = "A frequência precisa estar entre 31 e 65535";
Blockly.Msg.ARD_TYPE_ARRAY = "Array";
Blockly.Msg.ARD_TYPE_BOOL = "Booleano";
Blockly.Msg.ARD_TYPE_CHAR = "Caractere";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "BlocoFilhoFaltando";
Blockly.Msg.ARD_TYPE_DECIMAL = "Decimal";
Blockly.Msg.ARD_TYPE_LONG = "Número Longo";
Blockly.Msg.ARD_TYPE_NULL = "Nulo";
Blockly.Msg.ARD_TYPE_NUMBER = "Número";
Blockly.Msg.ARD_TYPE_SHORT = "Número Curto";
Blockly.Msg.ARD_TYPE_TEXT = "Texto";
Blockly.Msg.ARD_TYPE_UNDEF = "Indefinido";
Blockly.Msg.ARD_VAR_AS = "como";
Blockly.Msg.ARD_VAR_AS_TIP = "Setar um valor para um tipo específico.";
Blockly.Msg.ARD_WRITE_TO = "para";
...
Blockly.Msg.FR_BUTTON = "FRButton";
Blockly.Msg.FR_BUTTON_DEFAULT_NAME = "botao";
Blockly.Msg.FR_BUTTON_PIN = "pino:";
Blockly.Msg.FR_BUTTON_READ = "ler";
Blockly.Msg.FR_BUTTON_READ_TIP = "Lê o estado do botão (0 = Solto; 1 = Pressionado).";
Blockly.Msg.FR_BUTTON_SETUP = "Configurar Botão:";
Blockly.Msg.FR_BUTTON_SETUP_TIP = "Configura os pinos do botão.";
Blockly.Msg.FR_DISTANCE_SENSOR = "FRDistanceSensor";
Blockly.Msg.FR_DISTANCE_SENSOR_DEFAULT_NAME = "sensorDistancia";
Blockly.Msg.FR_DISTANCE_SENSOR_ECHO_PIN = "pino echo:";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_CM = "ler distância (cm)";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_CM_TIP = "Lê a distância em cm.";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_INCH = "ler distância (inch)";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_INCH_TIP = "Lê a distância em mm.";
Blockly.Msg.FR_DISTANCE_SENSOR_SETUP = "Configurar Sensor de Distância";
Blockly.Msg.FR_DISTANCE_SENSOR_SETUP_TIP = "Configura os pinos do Sensor de Distância.";
Blockly.Msg.FR_DISTANCE_SENSOR_TRIGGER_PIN = "pino trigger:";
Blockly.Msg.FR_LINE_SENSOR = "FRLineSensor";
Blockly.Msg.FR_LINE_SENSOR_CAL_STATUS = "verificar calibração";
Blockly.Msg.FR_LINE_SENSOR_CAL_STATUS_TIP = "Verifica se os dois níveis de detecção (Linha e Background) foram configurados.";
Blockly.Msg.FR_LINE_SENSOR_CHECK = "checar";
Blockly.Msg.FR_LINE_SENSOR_CHECK_TIP = "Retorna verdadeiro se for encontrado um desvio do nível da linha de detecção, falso caso contrário";
Blockly.Msg.FR_LINE_SENSOR_DEFAULT_NAME = "sensorLinha";
Blockly.Msg.FR_LINE_SENSOR_PIN = "pino:";
Blockly.Msg.FR_LINE_SENSOR_READ = "ler";
Blockly.Msg.FR_LINE_SENSOR_READ_TIP = "Lê o valor lido pelo sensor (0 - 1023).";
Blockly.Msg.FR_LINE_SENSOR_SETUP = "Configurar Sensor de Linha";
Blockly.Msg.FR_LINE_SENSOR_SETUP_TIP = "Configura o pino do sensor de linha. Deve ser um pino analógico.";
Blockly.Msg.FR_LINE_SENSOR_SET_BG = "calibrar nível do background";
Blockly.Msg.FR_LINE_SENSOR_SET_BG_TIP = "Configura o nível de detecção da cor do background do caminho.";
Blockly.Msg.FR_LINE_SENSOR_SET_DETECT = "calibrar nível da linha";
Blockly.Msg.FR_LINE_SENSOR_SET_DETECT_TIP = "Configura o nível de detecção da cor da linha do caminho.";
Blockly.Msg.FR_MOTORS = "FalconMotors";
Blockly.Msg.FR_MOTORS_DEFAULT_NAME = "motores";
Blockly.Msg.FR_MOTORS_DIRECTION_BACKWARD = "RÉ";
Blockly.Msg.FR_MOTORS_DIRECTION_FORWARD = "FRENTE";
Blockly.Msg.FR_MOTORS_DIRECTION_LEFT = "ESQUERDA";
Blockly.Msg.FR_MOTORS_DIRECTION_PIN_1 = "pino direção m1";
Blockly.Msg.FR_MOTORS_DIRECTION_PIN_2 = "pino direção m2";
Blockly.Msg.FR_MOTORS_DIRECTION_RIGHT = "DIREITA";
Blockly.Msg.FR_MOTORS_DRIVE = "mover";
Blockly.Msg.FR_MOTORS_DRIVE_DELAY = "duração(ms)";
Blockly.Msg.FR_MOTORS_DRIVE_DELAY_TIP = "Move o robô com uma direção(FRENTE ou RÉ) com uma velocidade(0 - 100%) por um período(ms).";
Blockly.Msg.FR_MOTORS_DRIVE_DIRECTION = "direção:";
Blockly.Msg.FR_MOTORS_DRIVE_LEFT = "mover motor esquerdo";
Blockly.Msg.FR_MOTORS_DRIVE_LEFT_DELAY_TIP = "Move motor esquerdo para uma direção(FRENTE or RÉ) com uma velocidade(0 - 100%) por um período(ms).";
Blockly.Msg.FR_MOTORS_DRIVE_LEFT_TIP = "Move motor esquerdo para uma direção(FRENTE or RÉ) com uma velocidade(0 - 100%).";
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT = "move motor direito";
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT_DELAY_TIP = "Move motor direito para uma direção(FRENTE or RÉ) com uma velocidade(0 - 100%) por um período(ms).";
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT_TIP = "Move motor direito para uma direção(FRENTE or RÉ) com uma velocidade(0 - 100%).";
Blockly.Msg.FR_MOTORS_DRIVE_SPEED = "velocidade(%):";
Blockly.Msg.FR_MOTORS_DRIVE_TIP = "Move o robô com uma direção(FRENTE ou RÉ) com uma velocidade(0 - 100%).";
Blockly.Msg.FR_MOTORS_PIVOT = "girar";
Blockly.Msg.FR_MOTORS_PIVOT_DELAY = "duração(ms)";
Blockly.Msg.FR_MOTORS_PIVOT_DELAY_TIP = "Gira o robô para um lado(ESQUERDA ou DIREITA) com uma velocidade(0 - 100%) por um período(ms).";
Blockly.Msg.FR_MOTORS_PIVOT_DIRECTION = "direção:";
Blockly.Msg.FR_MOTORS_PIVOT_SPEED = "velocidade(%):";
Blockly.Msg.FR_MOTORS_PIVOT_TIP = "Gira o robô para um lado(ESQUERDA ou DIREITA) com uma velocidade(0 - 100%).";
Blockly.Msg.FR_MOTORS_SETUP = "Configurar Motores:";
Blockly.Msg.FR_MOTORS_SETUP_TIP = "Configura os pinos do motor.";
Blockly.Msg.FR_MOTORS_SPEED_PIN_1 = "pino velocidade m1:";
Blockly.Msg.FR_MOTORS_SPEED_PIN_2 = "pino velocidade m2:";
Blockly.Msg.FR_MOTORS_STOP = "parar motores";
Blockly.Msg.FR_MOTORS_STOP_LEFT = "parar motor esquerdo";
Blockly.Msg.FR_MOTORS_STOP_LEFT_TIP = "Para motor esquerdo.";
Blockly.Msg.FR_MOTORS_STOP_RIGHT = "parar motor direito";
Blockly.Msg.FR_MOTORS_STOP_TIP = "Para os dois motores.";
Blockly.Msg.FR_MOTORS_STOP_TIP_RIGHT = "Para motor direito.";
...
Blockly.Msg.NEW_INSTANCE_TITLE = "Novo nome de instância:";
...
Blockly.Msg.RENAME_INSTANCE = "Renomeiar instância...";
Blockly.Msg.RENAME_INSTANCE_TITLE = "Renomeia todas as intâncias de '%1' para:";
