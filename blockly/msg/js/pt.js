...
Blockly.Msg.ARD_MOTOR = "motor:";
Blockly.Msg.ARD_MOTOR_COMPONENT = "motor";
Blockly.Msg.ARD_MOTOR_DEFAULT_NAME = "MeuMotor";
Blockly.Msg.ARD_MOTOR_DIRECTION_BACKWARD = "BACKWARD";
Blockly.Msg.ARD_MOTOR_DIRECTION_FORWARD = "FORWARD";
Blockly.Msg.ARD_MOTOR_DIRECTION_PIN = "pino direção:";
Blockly.Msg.ARD_MOTOR_SET = "Setar motor:";
Blockly.Msg.ARD_MOTOR_SETUP = "Configurar motor";
Blockly.Msg.ARD_MOTOR_SETUP_TIP = "Configura os pinos do motor.";
Blockly.Msg.ARD_MOTOR_SET_DIRECTION = "direção:";
Blockly.Msg.ARD_MOTOR_SET_DIRECTION_TIP = "Define direção(FORWARD ou BACKWARD) do motor.";
Blockly.Msg.ARD_MOTOR_SET_SPEED = "velocidade(%):";
Blockly.Msg.ARD_MOTOR_SET_SPEED_TIP = "Define velocidade(0 - 100%) do motor.";
Blockly.Msg.ARD_MOTOR_SET_TIP = "Define direção(FORWARD or BACKWARD) e velocidade(0 - 100%) do motor.";
Blockly.Msg.ARD_MOTOR_SPEED_PIN = "pino velocidade:";
...
Blockly.Msg.ARD_ULTRASONIC = "ultrassônico:";
Blockly.Msg.ARD_ULTRASONIC_COMPONENT = "ultrasonic";
Blockly.Msg.ARD_ULTRASONIC_DEFAULT_NAME = "MeuUltrassonico";
Blockly.Msg.ARD_ULTRASONIC_ECHO_PIN = "pino echo:";
Blockly.Msg.ARD_ULTRASONIC_READ = "ler distancia";
Blockly.Msg.ARD_ULTRASONIC_READ_TIP = "Retorna a distância lida pelo sensor ultrassônico.";
Blockly.Msg.ARD_ULTRASONIC_SETUP = "Configurar ultrassônico";
Blockly.Msg.ARD_ULTRASONIC_SETUP_TIP = "Configura os pinos do sensor ultrassônico.";
Blockly.Msg.ARD_ULTRASONIC_TRIGGER_PIN = "pino trigger:";
