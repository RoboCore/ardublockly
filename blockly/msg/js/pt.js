...
Blockly.Msg.FR_BUTTON_0 = "FalconButton0";
Blockly.Msg.FR_BUTTON_0_PIN = "pin:";
Blockly.Msg.FR_BUTTON_0_READ = "Read Button0";
Blockly.Msg.FR_BUTTON_0_READ_TIP = "Read the state of Button0 (0 = Realeased; 1 = Pressed).";
Blockly.Msg.FR_BUTTON_0_SETUP = "Setup Button0:";
Blockly.Msg.FR_BUTTON_0_SETUP_TIP = "Configures the button 0 pin.";
Blockly.Msg.FR_BUTTON_1 = "FalconButton1";
Blockly.Msg.FR_BUTTON_1_PIN = "pin:";
Blockly.Msg.FR_BUTTON_1_READ = "Read Button1";
Blockly.Msg.FR_BUTTON_1_READ_TIP = "Read the state of Button1 (0 = Realeased; 1 = Pressed).";
Blockly.Msg.FR_BUTTON_1_SETUP = "Setup Button1:";
Blockly.Msg.FR_BUTTON_1_SETUP_TIP = "Configures the button 1 pin.";
Blockly.Msg.FR_DISTANCE_SENSOR = "Distance Sensor";
Blockly.Msg.FR_DISTANCE_SENSOR_ECHO_PIN = "echo pin:";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_CM = "Read Distance (CM)";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_CM_TIP = "Reads the distance in CM.";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_INCH = "Read Distance (INCH)";
Blockly.Msg.FR_DISTANCE_SENSOR_READ_INCH_TIP = "Reads the distance in INCH.";
Blockly.Msg.FR_DISTANCE_SENSOR_SETUP = "Setup Distance Sensor";
Blockly.Msg.FR_DISTANCE_SENSOR_SETUP_TIP = "Configures the Distance Sensor pinout.";
Blockly.Msg.FR_DISTANCE_SENSOR_TRIGGER_PIN = "trigger pin:";
...
Blockly.Msg.FR_MOTORS_DIRECTION_PIN_1 = "direction pin m1";
Blockly.Msg.FR_MOTORS_DIRECTION_PIN_2 = "direction pin m2";
Blockly.Msg.FR_MOTORS_DIRECTION_RIGHT = "RIGHT";
Blockly.Msg.FR_MOTORS_DRIVE = "Drive";
Blockly.Msg.FR_MOTORS_DRIVE_DELAY = "Duration(ms)";
Blockly.Msg.FR_MOTORS_DRIVE_DELAY_TIP = "Drive motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";
Blockly.Msg.FR_MOTORS_DRIVE_DIRECTION = "direction:";
Blockly.Msg.FR_MOTORS_DRIVE_LEFT = "Drive left motor";
Blockly.Msg.FR_MOTORS_DRIVE_LEFT_DELAY_TIP = "Drive left motor with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";
Blockly.Msg.FR_MOTORS_DRIVE_LEFT_TIP = "Drive left motor with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT = "Drive right motor";
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT_DELAY_TIP = "Drive right motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT_TIP = "Drive right motor with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";
Blockly.Msg.FR_MOTORS_DRIVE_SPEED = "speed(%):";
Blockly.Msg.FR_MOTORS_DRIVE_TIP = "Drive motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";
Blockly.Msg.FR_MOTORS_PIVOT = "Pivot";
Blockly.Msg.FR_MOTORS_PIVOT_DELAY = "Duration(ms)";
Blockly.Msg.FR_MOTORS_PIVOT_DELAY_TIP = "Pivot motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";
Blockly.Msg.FR_MOTORS_PIVOT_DIRECTION = "direction:";
Blockly.Msg.FR_MOTORS_PIVOT_SPEED = "speed(%):";
Blockly.Msg.FR_MOTORS_PIVOT_TIP = "Pivot motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";
Blockly.Msg.FR_MOTORS_SETUP = "Setup Motors:";
Blockly.Msg.FR_MOTORS_SETUP_TIP = "Configures the motors pinout.";
Blockly.Msg.FR_MOTORS_SPEED_PIN_1 = "speed pin m1:";
Blockly.Msg.FR_MOTORS_SPEED_PIN_2 = "speed pin m2:";
Blockly.Msg.FR_MOTORS_STOP = "Stop";
Blockly.Msg.FR_MOTORS_STOP_LEFT = "Stop left motor";
Blockly.Msg.FR_MOTORS_STOP_LEFT_TIP = "Stop left motor.";
Blockly.Msg.FR_MOTORS_STOP_RIGHT = "Stop right motor";
Blockly.Msg.FR_MOTORS_STOP_TIP = "Stop the both motors.";
Blockly.Msg.FR_MOTORS_STOP_TIP_RIGHT = "Stop right motor";
