...
Blockly.Msg.FR_BUTTON = "Button";
Blockly.Msg.FR_BUTTON_DEFAULT_NAME = "button";
Blockly.Msg.FR_BUTTON_PIN = "pin:";
Blockly.Msg.FR_BUTTON_READ = "read";
Blockly.Msg.FR_BUTTON_READ_TIP = "Read the state of Button (0 = Realeased; 1 = Pressed).";
Blockly.Msg.FR_BUTTON_SETUP = "Setup Button:";
Blockly.Msg.FR_BUTTON_SETUP_TIP = "Configures the button pin.";
Blockly.Msg.FR_DISTANCE_SENSOR = "DistanceSensor";
...
Blockly.Msg.FR_LINE_SENSOR = "LineSensor";
Blockly.Msg.FR_LINE_SENSOR_CAL_STATUS = "calibration state";
Blockly.Msg.FR_LINE_SENSOR_CAL_STATUS_TIP = "Verifies if the both levels (Line and Background) has been setted.";
Blockly.Msg.FR_LINE_SENSOR_CHECK = "check";
Blockly.Msg.FR_LINE_SENSOR_CHECK_TIP = "Returns true if a deviation from detect line level is found, false otherwise.";
Blockly.Msg.FR_LINE_SENSOR_DEFAULT_NAME = "lineSensor";
Blockly.Msg.FR_LINE_SENSOR_PIN = "pin:";
Blockly.Msg.FR_LINE_SENSOR_READ = "read";
Blockly.Msg.FR_LINE_SENSOR_READ_TIP = "Reads the line sensor pin analog value (0 - 1023).";
Blockly.Msg.FR_LINE_SENSOR_SETUP = "Setup Line Sensor";
Blockly.Msg.FR_LINE_SENSOR_SETUP_TIP = "Configures the Line Sensor pinout. This should be a analog input.";
Blockly.Msg.FR_LINE_SENSOR_SET_BG = "set background level";
Blockly.Msg.FR_LINE_SENSOR_SET_BG_TIP = "Configures the level of the background color of the path.";
Blockly.Msg.FR_LINE_SENSOR_SET_DETECT = "set line level";
Blockly.Msg.FR_LINE_SENSOR_SET_DETECT_TIP = "Configures the level of the line color of the path.";
...
Blockly.Msg.FR_MOTORS_PIVOT_DELAY_TIP = "Pivot motors with a direction(LEFT or RIGHT) and a speed(0 - 100%) per a Period(ms).";
Blockly.Msg.FR_MOTORS_PIVOT_DIRECTION = "direction:";
Blockly.Msg.FR_MOTORS_PIVOT_SPEED = "speed(%):";
Blockly.Msg.FR_MOTORS_PIVOT_TIP = "Pivot motors with a direction(LEFT or RIGHT) and a speed(0 - 100%).";
...
Blockly.Msg.FR_MOTORS_STOP = "stop motors";
