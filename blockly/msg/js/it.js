...
Blockly.Msg.FR_BUTTON = "Button";  // untranslated
Blockly.Msg.FR_BUTTON_DEFAULT_NAME = "button";  // untranslated
Blockly.Msg.FR_BUTTON_PIN = "pin:";  // untranslated
Blockly.Msg.FR_BUTTON_READ = "read";  // untranslated
Blockly.Msg.FR_BUTTON_READ_TIP = "Read the state of Button (0 = Realeased; 1 = Pressed).";  // untranslated
Blockly.Msg.FR_BUTTON_SETUP = "Setup Button:";  // untranslated
Blockly.Msg.FR_BUTTON_SETUP_TIP = "Configures the button pin.";  // untranslated
Blockly.Msg.FR_DISTANCE_SENSOR = "DistanceSensor";  // untranslated
Blockly.Msg.FR_DISTANCE_SENSOR_DEFAULT_NAME = "distanceSensor";  // untranslated
...
Blockly.Msg.FR_LINE_SENSOR = "LineSensor";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_CAL_STATUS = "calibration state";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_CAL_STATUS_TIP = "Verifies if the both levels (Line and Background) has been setted.";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_CHECK = "check";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_CHECK_TIP = "Returns true if a deviation from detect line level is found, false otherwise.";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_DEFAULT_NAME = "lineSensor";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_PIN = "pin:";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_READ = "read";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_READ_TIP = "Reads the line sensor pin analog value (0 - 1023).";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_SETUP = "Setup Line Sensor";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_SETUP_TIP = "Configures the Line Sensor pinout. This should be a analog input.";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_SET_BG = "set background level";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_SET_BG_TIP = "Configures the level of the background color of the path.";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_SET_DETECT = "set line level";  // untranslated
Blockly.Msg.FR_LINE_SENSOR_SET_DETECT_TIP = "Configures the level of the line color of the path.";  // untranslated
...
Blockly.Msg.FR_MOTORS_DIRECTION_FORWARD = "FORWARD";  // untranslated
Blockly.Msg.FR_MOTORS_DIRECTION_LEFT = "LEFT";  // untranslated
Blockly.Msg.FR_MOTORS_DIRECTION_PIN_1 = "direction pin m1";  // untranslated
Blockly.Msg.FR_MOTORS_DIRECTION_PIN_2 = "direction pin m2";  // untranslated
Blockly.Msg.FR_MOTORS_DIRECTION_RIGHT = "RIGHT";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE = "drive";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_DELAY = "duration(ms)";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_DELAY_TIP = "Drive motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_DIRECTION = "direction:";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_LEFT = "drive left motor";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_LEFT_DELAY_TIP = "Drive left motor with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_LEFT_TIP = "Drive left motor with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT = "drive right motor";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT_DELAY_TIP = "Drive right motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%) per a Period(ms).";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_RIGHT_TIP = "Drive right motor with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_SPEED = "speed(%):";  // untranslated
Blockly.Msg.FR_MOTORS_DRIVE_TIP = "Drive motors with a direction(FORWARD or BACKWARD) and a speed(0 - 100%).";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT = "pivot";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_DELAY = "duration(ms)";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_DELAY_TIP = "Pivot motors with a direction(LEFT or RIGHT) and a speed(0 - 100%) per a Period(ms).";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_DIRECTION = "direction:";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_SPEED = "speed(%):";  // untranslated
Blockly.Msg.FR_MOTORS_PIVOT_TIP = "Pivot motors with a direction(LEFT or RIGHT) and a speed(0 - 100%).";  // untranslated
Blockly.Msg.FR_MOTORS_SETUP = "Setup Motors:";  // untranslated
Blockly.Msg.FR_MOTORS_SETUP_TIP = "Configures the motors pinout.";  // untranslated
Blockly.Msg.FR_MOTORS_SPEED_PIN_1 = "speed pin m1:";  // untranslated
Blockly.Msg.FR_MOTORS_SPEED_PIN_2 = "speed pin m2:";  // untranslated
Blockly.Msg.FR_MOTORS_STOP = "stop motors";  // untranslated
Blockly.Msg.FR_MOTORS_STOP_LEFT = "stop left motor";  // untranslated
Blockly.Msg.FR_MOTORS_STOP_LEFT_TIP = "Stop left motor.";  // untranslated
Blockly.Msg.FR_MOTORS_STOP_RIGHT = "stop right motor";  // untranslated
Blockly.Msg.FR_MOTORS_STOP_TIP = "Stop the both motors.";  // untranslated
Blockly.Msg.FR_MOTORS_STOP_TIP_RIGHT = "Stop right motor";  // untranslated
