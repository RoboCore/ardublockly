...
Blockly.Msg.ARD_MOTOR = "motor:";  // untranslated
Blockly.Msg.ARD_MOTOR_COMPONENT = "motor";  // untranslated
Blockly.Msg.ARD_MOTOR_DEFAULT_NAME = "MyMotor";  // untranslated
Blockly.Msg.ARD_MOTOR_DIRECTION_BACKWARD = "BACKWARD";  // untranslated
Blockly.Msg.ARD_MOTOR_DIRECTION_FORWARD = "FORWARD";  // untranslated
Blockly.Msg.ARD_MOTOR_DIRECTION_PIN = "direction pin:";  // untranslated
Blockly.Msg.ARD_MOTOR_SET = "set motor:";  // untranslated
Blockly.Msg.ARD_MOTOR_SETUP = "Setup motor";  // untranslated
Blockly.Msg.ARD_MOTOR_SETUP_TIP = "Configures a motor pinout.";  // untranslated
Blockly.Msg.ARD_MOTOR_SET_DIRECTION = "direction:";  // untranslated
Blockly.Msg.ARD_MOTOR_SET_DIRECTION_TIP = "Set motor direction(FORWARD or BACKWARD).";  // untranslated
Blockly.Msg.ARD_MOTOR_SET_SPEED = "speed(%):";  // untranslated
Blockly.Msg.ARD_MOTOR_SET_SPEED_TIP = "Set motor speed(0 - 100%).";  // untranslated
Blockly.Msg.ARD_MOTOR_SET_TIP = "Set motor direction(FORWARD or BACKWARD) and  speed(0 - 100%).";  // untranslated
Blockly.Msg.ARD_MOTOR_SPEED_PIN = "speed pin:";  // untranslated
...
Blockly.Msg.ARD_ULTRASONIC = "ultrasonic sensor:";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_COMPONENT = "ultrasonic";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_DEFAULT_NAME = "MyUltrasonic";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_ECHO_PIN = "echo pin:";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_READ = "read distance";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_READ_TIP = "Read distance read by ultrasonic sensor.";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_SETUP = "Setup ultrasonic";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_SETUP_TIP = "Configures ultrasonic sensor pinout.";  // untranslated
Blockly.Msg.ARD_ULTRASONIC_TRIGGER_PIN = "trigger pin:";  // untranslated
